...
const crustSeeds = process.env.CRUST_SEEDS; // Create account(seeds): https://wiki.crust.network/docs/en/crustAccount
...
async function main() {
    ...
    const addedAmount = process.env.PREPAID_AMOUNT; // in pCRU, 1 pCRU = 10^-12 CRU
