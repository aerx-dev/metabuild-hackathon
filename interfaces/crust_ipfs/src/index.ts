...
const crustSeeds: string = process.env.CRUST_SEEDS ? process.env.CRUST_SEEDS : " "; // Create account(seeds): https://wiki.crust.network/docs/en/crustAccount
...
async function main() {
    ...
    // 1. Read file
    const filePath = process.env.FILE_PATH ? process.env.FILE_PATH : "DOTENV file not found!";
    ...
    const addedAmount: number = process.env.PREPAID_AMOUNT ? +process.env.PREPAID_AMOUNT : 1; // in pCRU, 1 pCRU = 10^-12 CRU
